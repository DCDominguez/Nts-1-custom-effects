...
int main(){
 ...
 const float slowAdv=phase_advance(.05f),fastAdv=phase_advance(.95f);req(fastAdv>slowAdv*5.f,"ROTATION does not materially increase moving-head phase advance");
