...
Current status: **FIELD 0.1-1 level-adjusted implementation candidate; hardware validation OPEN**.
...
Build and physically test FIELD 0.1-1 against unchanged CORE 0.3-0, then establish:
