...
At noon MIX, the design gains are dry 0.5 and wet 0.4 before stereo balance and overlap management. These gains are not a claim about perceived loudness. Use hardware listening to judge first-answer prominence and bloom.
...
See [hardware QA](docs/qa-0.1-0.md), [implementation specification](../../../LATTICE_FIELD_SPEC.md), and [build report](../../../reports/lattice/2026-09-10_field-0.1-0-build.md).
